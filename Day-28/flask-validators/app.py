...
class UserCheck:
    ...
    # Here we define the method that is run when the class is called. If the data in our field is in the list of words then raise a ValidationError object with a message.
...
class myForm(FlaskForm):
    username = StringField('Username', validators=[
        ...
        Length(min=2,max=15),
        CharCheck(message="Special characters cannot be used", banned = set(punctuation))
        ])
